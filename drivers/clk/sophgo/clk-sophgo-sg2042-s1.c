...
CLK_OF_DECLARE(sg2042_clkgen_s1, "sophgo,sg2042-clkgen-s1", sg2042_clkgen_init);
CLK_OF_DECLARE(sg2042_rpgate_s1, "sophgo,sg2042-rpgate-s1", sg2042_rpgate_init);
CLK_OF_DECLARE(sg2042_pll_s1, "sophgo,sg2042-pll-s1", sg2042_pll_init);
